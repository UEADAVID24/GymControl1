...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  List<TrainingModel> entrenamientosDelDia(
    ...
    final fechaNormalizada = normalizarFecha(fecha);

    return entrenamientos.where((entrenamiento) {
                ...
                children: [
                  Card(
                    child: Padding(
                      ...
                      child: TableCalendar<TrainingModel>(
                        ...
                        headerStyle: HeaderStyle(
                          ...
                          titleTextFormatter: (fecha, locale) {
                  ...
                  Text(
                    fechaParaMostrar(diaSeleccionado),
                  ...
                  Text(
                    entrenamientosSeleccionados.isEmpty
                  ...
                  if (entrenamientosSeleccionados.isEmpty)
                    const Card(
                      child: Padding(
                    ...
                    ...entrenamientosSeleccionados.map(
                      (entrenamiento) {
                        return Card(
